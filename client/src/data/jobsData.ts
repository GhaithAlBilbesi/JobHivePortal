...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    icon: "fa-code",
    description: "Tech Solutions Inc. is seeking a Junior Web Developer to join our development team. You'll work on building and maintaining web applications, with a focus on frontend development using React.",
    requirements: [
  ...
  },
  {
    ...
    icon: "fa-chart-bar",
    description: "Global Marketing Agency is looking for a Marketing Assistant to support our marketing team in creating and implementing campaigns for our clients. This is an excellent opportunity for recent graduates to gain hands-on experience in digital marketing.",
    requirements: [
  ...
  },
  {
    ...
    icon: "fa-chart-line",
    description: "DataSight Analytics is offering a Data Analyst internship for students interested in gaining real-world experience in data analysis. You'll work with our team on analyzing datasets, creating reports, and learning the fundamentals of business intelligence.",
    requirements: [
  ...
  },
  {
    ...
    icon: "fa-calculator",
    description: "Global Financial Services is seeking a Graduate Accountant to join our growing finance team. This position is perfect for recent graduates looking to start their career in accounting and finance.",
    requirements: [
